  ...
  return (
    <main>
      ...
      <section className="intro">
        <div>
          ...
          <p>
            ...
            <br className="desktop" /> inspect each decision, and recompute the
            result.
          </p>
        </div>
      ...
      <section className="middle">
        <article className="panel chartpanel">
          ...
          <div className="chartfooter">
            ...
            <span>
              {state?.mode === "demo" ? "SIMULATED BLOCKS" : "FINALIZED BLOCKS"}
            </span>
          </div>
        </article>
      ...
      <section className="bottom">
        <article className="panel ledger">
          ...
          <div className="tablewrap">
            ...
            {!rewards.length && <p className="empty">No fills recorded yet.</p>}
          </div>
          <p className="footnote">
            Route regret is stubbed and excluded. The LLM judge is off-chain and
        ...
        <article className="panel lifecycle">
          ...
          {state?.lifecycle
            ...
            .map((d) => (
              <div className="event" key={d.id}>
                <span className={d.action === "retire" ? "retire" : "promote"}>
                  {d.action === "retire" ? "↘" : "↗"}
                </span>
                <div>
                  <strong>
          ...
          {!state?.lifecycle.length && (
            <p className="muted">
              Promotions and retirements appear here as the allocator evaluates
              evidence.
            </p>
          )}
        </article>
      ...
      <footer>
        ...
        <span>{state?.mode === "demo" ? "DEMO DATA" : "PUBLIC EVIDENCE"}</span>
      </footer>
    </main>
  );
}
